...
public interface TirocinioDAO {
    ...
    List<Tirocinio> searchTirocinio(int durata, String titolo, boolean facilitazioni, String luogo, String settore, String obiettivi, String corsoStudio) throws DataLayerException;
}
